...
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.occupied_space_weight = 40  -- by motoms 占有空間に対する重み
--TRAJECTORY_BUILDER_2D.ceres_scan_matcher.rotation_weight = 40  -- 回転に対する重み
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.rotation_weight = 160  -- by motoms 回転に対する重み
