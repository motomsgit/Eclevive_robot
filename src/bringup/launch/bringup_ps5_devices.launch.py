...
def generate_launch_description():
    ...
    # Box filter for filtering robot body from merged_scan
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            arguments=['-0.0','0','-0.03', '0','0','0','zed_camera_link','front_lidar'] #laserの高さは前後のデバイスで一致していないとmerged_scanでslamが安定しない.
